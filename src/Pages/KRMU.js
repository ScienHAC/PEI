  ...
  return (
    <div style={{ maxWidth: '1100px', margin: '40px auto', padding: '0 20px', fontFamily:'Roboto, sans-serif', lineHeight:1.65 }}>
      <header style={{ textAlign:'center', marginBottom:40 }}>
        <h1 style={{ fontSize:'2.4rem', fontWeight:700, color:'#084c61', marginBottom:10 }}>K.R. Mangalam University (KRMU)</h1>
        <p style={{ maxWidth:800, margin:'0 auto', color:'#333', fontSize:'1rem' }}>An institution fostering interdisciplinary excellence, research innovation and holistic development.</p>
      </header>
